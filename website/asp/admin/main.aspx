<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="main.aspx.cs" Inherits="WebSite.asp.main" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <title>普通高等院校学籍管理系统</title>
    
    <link href="../../Jscript/easyui1.2.6/css/default.css" rel="stylesheet" type="text/css" />
        ...
        $(function() {
            ...
            $('#loginOut').click(function() {
                $.messager.confirm('系统提示', '您确定要退出本次登录吗?', function(r) {
                    ...
                    if (r) {
                        location.href = 'asp/userLogin.aspx';
                    }
                });
            })
        });
...
<div style=" position:absolute; z-index:100000; height:2046px;top:0px;left:0px; width:100%; background:white; text-align:center;">
    <img src="../../Jscript/easyui1.2.6/images/noscript.gif" alt='抱歉，请开启脚本支持！' />
</div></noscript>
...
<div id="pageloading" style="position:absolute; top:50%; left:50%; margin:-120px 0px 0px -120px; text-align:center;  border:2px solid #8DB2E3; width:200px; height:40px;  font-size:14px;padding:10px; font-weight:bold; background:#fff; color:#15428B;"> 
    ...
    <div region="south" split="true" style="height: 30px; background: #D2E0F2; ">
        <div class="footer">2009级计算机系方金娟毕业作品</div>
    </div>
